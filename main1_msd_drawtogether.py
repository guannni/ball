...
# path2 = 'D:\\guan2019\\2_ball\\2_data_new\\60Hz_rot(qua4)_msd_selected\\'  # quaternions
...
#
# ax.set_title('Translational MSD [60Hz]', fontsize=10)
# ax.set_ylabel(r'$\langle\Delta R^2 \rangle ~(mm^2)$')
ax.set_title('Rotational MSD [60Hz]', fontsize=10)
