...
# path2 = 'D:\\guan2019\\2_ball\\2_data\\60Hz_copy\\'  # TODO: 注意 这里只用_copy文件夹的数据！！！！
path2 = 'D:\\guan2019\\2_ball\\2_data\\60tt\\'  # TODO: 注意 这里只用_copy文件夹的数据！！！！
filename = [name for name in os.listdir(path2)]

# path4 = 'D:\\guan2019\\2_ball\\3_ananlysis\\trans\\msd\\60Hz_tt\\'
path4 = 'D:\\guan2019\\2_ball\\3_ananlysis\\trans\\msd\\60tt\\'

# pdf_trans_dict = {}
for j in range(len(filename)):  #  2,3):    #
